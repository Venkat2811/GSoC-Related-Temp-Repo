...
OTHERALGORITHMPARAMS: (WHITESPACE | WS | NEWLINE)* COMMA_SYMBOL (WHITESPACE | WS | NEWLINE)*
                      UPDATEINTERVAL LPAREN LBTIMESTRINGX RPAREN
                    ;

PERSISTENCETYPEDEF: TYPE LPAREN PERSISTENCETYPEX RPAREN
                  ;

OTHERPERSISTENCEPARAMS: (WHITESPACE | WS | NEWLINE)* COMMA_SYMBOL (WHITESPACE | WS | NEWLINE)*
                         SESSIONTIMEOUT LPAREN LBTIMESTRINGX RPAREN
                      ;

SSLTYPEDEF: TYPE LPAREN SSLSUPPORTTYPEX RPAREN
          ;

HEALTHCHECKTYPEDEF: TYPE LPAREN HEALTHCHECKTYPEX RPAREN
                  ;

OTHERHEALTHCHECKPARAMS: (WHITESPACE | WS | NEWLINE)* COMMA_SYMBOL (WHITESPACE | WS | NEWLINE)*
                        (UNHEALTHYRETRIES | HEALTHYRETRIES | HEALTHYCHECKINTERVAL) LPAREN (HEALTHCHECKRETRIESCOUNTX | LBTIMESTRINGX) RPAREN
                     ;
